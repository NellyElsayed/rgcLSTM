...
weights_file = os.path.join(WEIGHTS_DIR, 'pred_rgcLSTM_kitti_weights.hdf5')  # where weights will be saved
json_file = os.path.join(WEIGHTS_DIR, 'pred_rgcLSTM_kitti_model.json')
...
nb_epoch = 150 # change to 1 in case of 
batch_size = 4
samples_per_epoch = 500 # change to the number of the samples based on how you will divide the moving 
#MNIST to traing, validation and testing (for this line and the next line of code)
N_seq_val = 100  # number of sequences to use for validation

# Model parameters
n_channels, im_height, im_width = (3, 128, 160) #change to (1,64,64) in case of moving MNIST
