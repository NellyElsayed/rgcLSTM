# -*- coding: utf-8 -*-
"""
Created on Thu Oct 25 18:34:00 2018
...
legacy_pred_rgcLSTM_support = generate_legacy_interface(
...
def convert_model_to_keras2(old_json_file, old_weights_file, new_json_file, new_weights_file):
    ...
    json_string = f.read()
    f.close()
    model = model_from_json(json_string, custom_objects = {'Pred_rgcLSTM': Pred_rgcLSTM})
...
if __name__ == '__main__':
    ...
    for w_tag in ['', '-Lall', '-extrapfinetuned']:
        ...
        convert_model_to_keras2(old_dir + 'pred_rgcLSTM_kitti_model' + m_tag + '.json',
                                old_dir + 'pred_rgcLSTM_kitti_weights' + w_tag + '.hdf5',
                                new_dir + 'pred_rgcLSTM_kitti_model' + m_tag + '.json',
                                new_dir + 'pred_rgcLSTM_recLSTM_kitti_weights' + w_tag + '.hdf5')
